...
<template>
    ...
    <aside class='bg-gray-200 bg-gri-300' style="width: 55px;">
            <div class="flex flex-col items-center w-16  overflow-hidden text-gray-700">
                ...
                <div class="flex flex-col items-center mt-2 border-t border-gray-300">
                    <Link :href="route('user.index')" class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-300">
                    ...
                    <Link :href="route('department.index')" class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-300">
                        <svg class="h-6 w-6 text-blue-500"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"
