...
<template>
    <div>
        <aside class="flex hidden w-64 bg-white border-r dark:border-primary-darker dark:bg-darker sm:flex">
            <div class="flex flex-col h-full flex-hull" style="z-index: 11;">
                <div class="h-16 border-b border-gray-100 hidden space-x-8 sm:flex" style="background-color: white;">
                    <h3
